...
Crc32Memory
    ...
    Calculates the CRC-32 checksum value of a block of memory.

Arguments:
    memory  - Pointer to a memory block to calcuate the CRC-32 checksum of.
...
Crc32String
    ...
    Calculates the CRC-32 checksum value of a string.

Arguments:
    string  - A pointer to a string to calculate the CRC-32 checksum of.
    ...
    )
{
    ...
    while (*string != '\0') {
        crc = crc32Table[(crc ^ *string++) & 0xFF] ^ (crc >> 8);
    }
    return crc ^ 0xFFFFFFFF;
}
...
Crc32UpperString
    ...
    Calculates the CRC-32 checksum value of an uppercase string.
    ...
    )
{
    ...
    while (*string != '\0') {
        ...
        crc = crc32Table[(crc ^ ch) & 0xFF] ^ (crc >> 8);
    }
    return crc ^ 0xFFFFFFFF;
}
